...
You can find the latest AAR hosted here: [https://dna-hosting.s3.amazonaws.com/public/com.devicenative.dna-vivo-v1.3.5.aar](https://dna-hosting.s3.amazonaws.com/public/com.devicenative.dna-vivo-v1.3.5.aar)
...
project-folder/libs/com.devicenative.dna-vivo-v1.3.5.aar
```
...
```gradle
dependencies {
    implementation files('libs/com.devicenative.dna-vivo-v1.3.5.aar')
}
```
